...
//GENEL KOMUTU
  ...
  .setFooter('Bu komutu kullanan kullanıcı ' + message.author.tag, message.author.displayAvatarURL())
   .setDescription(client.commands.filter(cmd => cmd.conf.kategori === 'Genel').map(cmd => `:white_small_square: - **${prefix}${cmd.help.name}** ${cmd.help.description}`).join("\n "))
        .addField("» Linkler", ` [Davet Et](https://discord.com/api/oauth2/authorize?client_id=935478496384417832&permissions=8&scope=bot)` + "** | **" + `[Destek Sunucusu](https://discord.gg/red2game)`  + "** | **" + `[Oy Ver]()`  + "** | **" + `[Web Sitesi](Şuanda Mevcut Degil)  `, false)
...
//YARDIM KOMUTU
  ...
  **[${prefix}yardım Genel](https://discord.gg/red2game)** 
  **[${prefix}yardım Eğlence](https://discord.gg/red2game)**
  **[${prefix}yardım Moderasyon](https://discord.gg/red2game)**
  **[${prefix}yardım Sunucu](https://discord.gg/red2game)**
  **[${prefix}yardım Sahip](https://discord.gg/red2game)**
  `)
  .addField("» Linkler", ` [Davet Et](https://discord.com/api/oauth2/authorize?client_id=935478496384417832&permissions=8&scope=bot)` + "** | **" + `[Destek Sunucusu](https://discord.gg/red2game)`  + "** | **" + `[Oy Ver]()`  + "** | **" + `[Web Sitesi](Şuanda Mevcut Degil)  `, false)
